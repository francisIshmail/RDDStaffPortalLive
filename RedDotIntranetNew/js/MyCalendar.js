         ...
         function calendarPicker(frmId,imgId,txtBoxId) //param is the name of the recipient textbox
            {
                        ...
                        TheNewWin=window.open("../MyCalendar.aspx?field=" + str,"calendarPopup","top="+NewWinTop+",left="+NewWinLeft+",width=240,height=214,status=0,titlebar=0,toolbar=0,resizable=no,scrollbars=0",true);                       

//                        TheNewWin=window.open("../MyCalendar.aspx?field=" + str,"calendarPopup","width=240,height=214,status=0,titlebar=0,toolbar=0,resizable=no,scrollbars=0",true);
//                         var NewWinLeft=arr[0];
//                         var NewWinTop=arr[1]; 
 ...
 //Function 1.           
            function getNewDate(caller)
            {
              ...
              {
               if(document.getElementById("lblMonth").innerHTML==arr[i])
                break;
              }
              mth=i+1;
               ...
               {
                 var yr=Number(document.getElementById("lblYear").innerHTML);
                 if(yr>1)
                  document.getElementById("lblYear").innerHTML=yr-1;
               }
             ...
             var nDate= mth + '/'+ document.getElementById("lblDate").innerHTML + '/'+ document.getElementById("lblYear").innerHTML;
            ...
            function funImgLeft()
            {
             var mth=document.getElementById("lblMonth").innerHTML;
             document.getElementById("lblMonth").innerHTML=NextPrevMonth(mth,"previousMonth");
            ...
            {
             var mth=document.getElementById("lblMonth").innerHTML;
             document.getElementById("lblMonth").innerHTML=NextPrevMonth(mth,"nextMonth");
	        ...
	        if(r==1)
	        {
	            for (var i=2; i<tblBodyObj.rows.length; i++) //count of rows in calander table
	            {
                   for (var c=0; c<tblBodyObj.rows[i].cells.length; c++)
                   {
                       ...
                       if(newc.innerHTML=='1' && flgS=='f')
                       {
                        flgS='t';
                       }
                       if(flgS=='t'&& prevVal<=newc.innerHTML)
                       {

...
public partial class Intranet_orders_ManagePlan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if (myGlobal.loggedInRole().ToLower() != "marketingadmin")
        ...
        if (!IsPostBack)
        {
            ...
            Db.LoadDDLsWithCon(ddlVendor, "select autoindex,buName from VendorBUDef", "buName", "autoindex", myGlobal.getRDDMarketingDBConnectionString());

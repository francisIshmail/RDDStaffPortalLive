<%@ Page Title="" Language="VB" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="false" CodeFile="sapAddOnceWarehouses.aspx.vb" Inherits="Intranet_sapBase_sapAddOnceWarehouses" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1"  runat="server">
     ...
     <table width="100%" style="border-color:#00A9F5;">
              <tr style="height:50px;background-color:#507CD1"> <%--row 1--%>
                <td>
                    <div class="Page-Title"><asp:Label ID="lblVersionNo" runat="server" Text="SAP - Addonce Warehouses"></asp:Label></div>
                </td>
              </tr>
            </table>   
            ...
            <td valign="top" style="width:40%">
                ...
                <asp:Panel ID="pnlItem" runat="server" GroupingText="Item" CssClass="addOncePanel" Enabled="False">
                       <table style="width:100%;">
                            <tr>
                                <td>
                                    Existing WH (<asp:Label ID="lblLstCnt" runat="server" Text="0" Font-Bold="True" ForeColor="#990099"></asp:Label>)</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    Warehouse Name </td>
                                <td>
                                    <asp:TextBox ID="txtDesc1" runat="server" Width="60%" MaxLength="100"></asp:TextBox>
                                    &nbsp;Max 100 Chrs</td>
                            </tr>
                        </table>
                </asp:Panel>    

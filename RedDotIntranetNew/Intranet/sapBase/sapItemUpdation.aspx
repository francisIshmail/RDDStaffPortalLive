<%@ Page Title="" Language="VB" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="false" CodeFile="sapItemUpdation.aspx.vb" Inherits="Intranet_sapBase_sapItemUpdation" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1"  runat="server">
     ...
     <table width="100%" style="border-color:#00A9F5;">
              <tr style="height:50px;background-color:#507CD1"> <%--row 1--%>
                <td>
                    <div class="Page-Title"><asp:Label ID="lblVersionNo" runat="server" Text="SAP - Update Stock Items"></asp:Label>
                        &nbsp;Ver 13-Feb-2017</div>
                </td>
              </tr>
            </table>   
      ...
      <tr style="height:25px">
        ...
        <tr> 
            <td colspan="4" align="left" valign="top" style="height:25px">
              Items Not Updated&nbsp;(<asp:Label ID="lblNotUpdatedCnt" runat="server" Font-Bold="True" Text="0" ForeColor="Red"></asp:Label>)
              &nbsp;

<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="true" CodeFile="SapTallyExportPurchasesV1.aspx.cs" Inherits="Intranet_sapBase_SapTallyExportPurchasesV1" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1"  runat="server">
        ...
        <table width="100%" style="border-color:#00A9F5;">
              <tr style="height:50px;background-color:#507CD1"> <%--row 1--%>
                <td>
                    <div class="Page-Title"><asp:Label ID="lblVersionNo" runat="server" Text="Export AP-Invoices to SAP Tally Database  ( Ver : 25-Aug-17 )"></asp:Label></div>
                </td>
              </tr>
       </table>   

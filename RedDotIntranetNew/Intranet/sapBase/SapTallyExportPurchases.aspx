<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="true" CodeFile="SapTallyExportPurchases.aspx.cs" Inherits="Intranet_sapBase_SapTallyExportPurchases" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1"  runat="server">
        ...
        <table width="100%" style="border-color:#00A9F5;">
              <tr style="height:50px;background-color:#507CD1"> <%--row 1--%>
                <td>
                    <div class="Page-Title"><asp:Label ID="lblVersionNo" runat="server" Text="Export AP-Invoices to SAP Tally Database using Direct Exchange ( Ver : 01-Nov-17 )"></asp:Label></div>
                </td>
              </tr>
       </table>   
    ...
    <table width="100%" style="background-color:White" border="0" cellpadding="5px">
       ...
       <tr style="background-color:#ecd9ff">
        ...
        <td><asp:Button ID="btnGetInvList" runat="server" 
                Text="Click ! Get Exportable AP Invoices !" ForeColor="#990099" Font-Bold="True"  Visible="true"
                        ToolTip="Get Exportable AP Invoices" Height="22px" Width="200px" 
                Font-Size="10px" onclick="btnGetInvList_Click"/></td>
        <td>&nbsp;</td> 
        <td>&nbsp;</td>
        <td><asp:Button ID="btnLoadCustList" runat="server" 
                Text="Export Suppliers To Tally" ForeColor="#990099" 
                BackColor="Gray" BorderColor="#FF9966" Font-Bold="True" 
                ToolTip="Export Suppliers to Tally From TZ not in Tally" Height="22px" 
       ...
       <tr style="background-color:#b8e7b8">
        ...
        <td><asp:Button ID="btnExport" runat="server" Text="Click ! Export Checked AP Invoices Now" ForeColor="#990099" 
                BackColor="Green" BorderColor="#FF9966" Font-Bold="True"  Visible="true" ToolTip="Export Checked AP Invoices in the Grid below" Height="22px" 
                    ...
                    <asp:GridView ID="Grid1" AutoGenerateColumns="False" CssClass="overallGrid" 
                     ...
                     <Columns>
                        <asp:TemplateField HeaderText="Export?">
                                 <ItemTemplate>
                                  <asp:CheckBox ID="chkExport" Text="" runat="server" Checked="false" Visible="false" Font-Bold="true" />
                                 </ItemTemplate>
                              ...
                              <asp:TemplateField HeaderText="Price" Visible="true">
                                <ItemTemplate > 
                                  <asp:Label ID="lblPriceUSD" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"usePrice")%>'></asp:Label>  
                                </ItemTemplate>
                              ...
                              <asp:TemplateField HeaderText="Amt" Visible="true">
                                <ItemTemplate > 
                                  <asp:Label ID="lblAmtUSD" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"useAmt")%>'></asp:Label>  
                                </ItemTemplate>
                              ...
                              <asp:TemplateField HeaderText="Vat" Visible="true">
                                <ItemTemplate > 
                                  <asp:Label ID="lblVatUSD" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"useVat")%>'></asp:Label>  
                                </ItemTemplate>
                              <ItemStyle CssClass="lighterData" HorizontalAlign="Left" Width="40px"  />
                              </asp:TemplateField>
                              
                              <asp:TemplateField HeaderText="Line Total" Visible="true">
                                <ItemTemplate > 
                                  <asp:Label ID="lblLineTotalUSD" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"useAmtInclVat")%>'></asp:Label>  
                                </ItemTemplate>
                              <ItemStyle CssClass="lighterData" HorizontalAlign="Left" Width="60px"  />
                              </asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="Curr" Visible="true">
                                <ItemTemplate > 
                                  <asp:Label ID="lblLineCurr" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"LineCurr")%>'></asp:Label>  
                                </ItemTemplate>
                              <ItemStyle CssClass="lighterData" HorizontalAlign="Left" Width="30px"  />
                              </asp:TemplateField>

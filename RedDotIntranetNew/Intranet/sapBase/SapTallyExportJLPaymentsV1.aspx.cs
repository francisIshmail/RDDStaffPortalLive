...
public partial class Intranet_sapBase_SapTallyExportJLPaymentsV1 : System.Web.UI.Page
{
                    ...
                    for (int ch = rw.RowIndex; ch<Grid1.Rows.Count; ch++)
                    {
                        ...
                        if (clblDocNum.Text == mlblDocNum.Text)
                        {
                            ...
                            if (firstRow == false && clblExp.Text == "1") 
                            {
                                ...
                                //{
                                    //if (clblSysCred.Text != "0")
                                    //    oFZEARInvoice.Lines.Credit = (Convert.ToDouble(clblSysCred.Text));

                                    //if (clblSysDeb.Text != "0")
                                    //    oFZEARInvoice.Lines.Debit = (Convert.ToDouble(clblSysDeb.Text));
                                //}

<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="true" CodeFile="SapTallyExportInvoicesCreditNotesLocal.aspx.cs" Inherits="Intranet_sapBase_SapTallyExportInvoicesCreditNotesLocal" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1"  runat="server">
        ...
        <table width="100%" style="border-color:#00A9F5;">
              <tr style="height:50px;background-color:#507CD1"> <%--row 1--%>
                <td>
                    <div class="Page-Title"><asp:Label ID="lblVersionNo" runat="server" Text="Export AR-Credit Notes Local to SAPTally using Direct Exchange ( Ver : 05-Feb-18 )"></asp:Label></div>
                </td>
              </tr>
       </table>   
                    ...
                    <asp:GridView ID="Grid1" AutoGenerateColumns="False" CssClass="overallGrid" 
                     ...
                     <Columns>
                        <asp:TemplateField HeaderText="Export?">
                              ...
                              <asp:TemplateField HeaderText="LineTotal" Visible="true">
                                <ItemTemplate > 

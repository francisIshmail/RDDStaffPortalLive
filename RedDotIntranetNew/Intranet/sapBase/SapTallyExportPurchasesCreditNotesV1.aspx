<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="true" CodeFile="SapTallyExportPurchasesCreditNotesV1.aspx.cs" Inherits="Intranet_sapBase_SapTallyExportPurchasesCreditNotesV1" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1"  runat="server">
        ...
        <table width="100%" style="border-color:#00A9F5;">
              <tr style="height:50px;background-color:#507CD1"> <%--row 1--%>
                <td>
                    <div class="Page-Title"><asp:Label ID="lblVersionNo" runat="server" Text="Export AP-Credit Notes to SAP Tally Database  ( Ver : 17-July-17 )"></asp:Label></div>
                </td>
              </tr>
       </table>   

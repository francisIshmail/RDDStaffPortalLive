...
public partial class Intranet_sapBase_SapTallyExportInvoicesCreditNotesV1 : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        string summarySQL = "Exec GetSAPTZCRNInvoiceDetailsV4 '" + ddlSourceDB.SelectedItem.Text + "','" + ddlDestDB.SelectedItem.Text + "'";

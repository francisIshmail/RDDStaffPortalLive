...
public partial class Intranet_sapBase_SapTallyExportInvoicesLocal : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        string summarySQL = "Exec GetSAPTZInvoiceDetailsV4Local '" + ddlSourceDB.SelectedItem.Text + "','" + ddlDestDB.SelectedItem.Text + "'";
                    ...
                    for (int ch = rw.RowIndex; ch<Grid1.Rows.Count; ch++)
                    {
                        ...
                        if (clblDocNum.Text == mlblDocNum.Text)
                        {
                            ...
                            if (clblLineNum.Text == "0")  //if starting line, so get val for max variables
                            {
                                ...
                                oFZEARInvoice.DocCurrency = invDocCurr;  // currency field is loaded here
                                ...
                                //oFZEARInvoice.Lines.SetCurrentLine(0);
                                //oFZEARInvoice.Lines.Currency = invDocCurr;
                            ...
                            else//line no >0
                            {
                                ...
                                //oFZEARInvoice.Lines.SetCurrentLine(ch);
                                //oFZEARInvoice.Lines.Currency = invDocCurr;
                                oFZEARInvoice.Lines.ItemDescription = clblDesc.Text;
                                oFZEARInvoice.Lines.VatGroup = clblVatTaxCod.Text;
                                oFZEARInvoice.Lines.AccountCode = clblGLAcct.Text;

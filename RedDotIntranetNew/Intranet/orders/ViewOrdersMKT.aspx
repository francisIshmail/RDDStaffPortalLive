<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern.master" AutoEventWireup="true" CodeFile="ViewOrdersMKT.aspx.cs" Inherits="Intranet_orders_ViewOrdersMKT" EnableEventValidation="false"%>
...
<table width="100%">
              ...
              <asp:Panel ID="panel1ProcessType" runat="server" CssClass="POPanel4" GroupingText="Select Process & Status">
                 <table width="100%" border="0px">
                  <tr>
                        ...
                        <td style="width:30%">
                            <asp:DropDownList ID="ddlProcessType" runat="server" Width="300px"  
                        ...
                        <td align="center" style="width:15%">
                         Work For :&nbsp <asp:DropDownList ID="ddlBaseYear" runat="server" BackColor="#800000" 
                                             Font-Size="9pt" Height="20px" Width="80px" Font-Bold="true" ForeColor="White"
        ...
        <tr>
            <td>
              <asp:Panel ID="panelWorkingRoles" runat="server" CssClass="POPanel1" GroupingText="Your are on Roles listed below ( Work As selected one)">
                                <table width="100%">
                                    <tr>
                                      <td style="width:60%">
                    ...
                    <tr>
                        <td  colspan="2">
                            ...
                            <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Vendor/BU" SortExpression="bu">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Process Value" SortExpression="refValue">
                                        <ItemTemplate>
                                            <asp:Label ID="lblrefValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "refValueNew")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

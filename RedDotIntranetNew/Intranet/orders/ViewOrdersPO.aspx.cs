...
public partial class Intranet_orders_ViewOrdersPO : System.Web.UI.Page
{
    string qry;
    //string[] userRole;
    ...
    protected void gridTasks_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (templblType.Text == "PO-BTB" || templblType.Text == "PO-RR1" || templblType.Text == "PO-RR2")
            Response.Redirect("~/Intranet/orders/purchaseOrderDetails.aspx?oId=" + gridTasks.SelectedDataKey.Value + "&pid=" + templblpid.Text + "&action=task&qrls=" + lblworkForRole.Text);
    ...
    protected void gridOrders_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (templblType.Text == "PO-BTB" || templblType.Text == "PO-RR1" || templblType.Text == "PO-RR2")
            Response.Redirect("~/Intranet/orders/purchaseOrderDetails.aspx?oId=" + gridOrders.SelectedDataKey.Value + "&pid=" + templblpid.Text + "&action=view&qrls=" + lblworkForRole.Text);
        if (templblType.Text == "MKT")
    ...
    {
        Response.Redirect("PurchaseOrder.aspx?ptype=New&poid=0&wfProcessId="+ddlProcessType.SelectedValue.ToString()+"&ordType="+lblprocessSubType.Text + "&qrls=" + lblworkForRole.Text);
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern.master" AutoEventWireup="true" CodeFile="planDetailsold.aspx.cs" Inherits="Intranet_orders_PlanDetailsold" %>
            ...
            <table id="tblDetails" runat="server" width="100%" style="border-style:solid; border-width:0px; padding:0px; font-size:12px;background-color:#DFEFFF">
                ...
                <tr>
                    <td style="width:100%">
                        ...
                        &nbsp;Version Dated :&nbsp;<asp:Label ID="lblThisVerDate" runat="server" Font-Bold="True" Font-Size="14px" Font-Names="Calibri" Visible="true" ForeColor="Silver" Text="03-26-2013"></asp:Label>
                    ...
                    <td style="width:100%">   
                        <asp:Panel ID="panelInfo" runat="server" CssClass="PlansPanel" GroupingText="Plan Information" >
                            <table width="95%">
                                ...
                                <tr>
                                    <td style="width:20%">Vendor Approved $</td>
                                    <td style="width:22%"><asp:Label ID="txtApprovedAmt" runat="server" Text="" ></asp:Label></td>
                                ...
                                <td>
                                 ...
                                 <td align="right">
                                    <asp:Button ID="btnSubmit" runat="server" Width="150px" Text="Submit is hidden" onclick="btnSubmit_Click" OnClientClick="disableBtn(this.id, 'Submitting...')"  UseSubmitBehavior="false" style="display:none" />
                                     <input id="btnSubmitHtml" type="button" value="Submit" onclick="ConfirmForUpdate();" class="btnStyle" />
                                 </td>
                            </tr>
                        </table>
                    </td>

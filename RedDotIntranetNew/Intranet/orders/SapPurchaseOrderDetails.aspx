<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern.master" AutoEventWireup="true" CodeFile="SapPurchaseOrderDetails.aspx.cs" Inherits="Intranet_orders_SapPurchaseOrderDetails" %>
                              ...
                              <tr style="height:30px;background-color:#507CD1"> <%--row 1--%>
                                 <td style="width:96%" align="center">
                                    <div class="Page-Title">
                                     SAP &nbsp;<asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="18px" Font-Names="Calibri"></asp:Label>
                                     &nbsp;<asp:Label ID="lblVerUpd" runat="server" Text="Ver. 19-Sep-2017" Font-Bold="True" Font-Size="10px" Font-Names="Calibri"></asp:Label>
                                    </div>
                                        ...
                                        <td>
                                            <table width="100%" border="0px">
                                                <tr>
                                                    ...
                                                    <td style="width:40%">
                                                        <asp:TextBox ID="txtFindPartLike" Text="AP50" runat="server" Width="50%" Font-Size="10px" ForeColor="Maroon"  BackColor="#6699ff" Font-Bold="true" ></asp:TextBox>
                                                        &nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:40%">
                                                        <asp:DropDownList ID="ddlPartNo" Width="82%" Font-Size="10px" ForeColor="#666666"  BackColor="#D8E9E9" Font-Bold="true" runat="server" 
                                                        ...
                                                        <table width="100%" style="border-style:solid;border-width:0px;background-color:#FDF3CD" border="0">
                                                            <tr>
                                                                <td style="width:40%;padding-left:10px">
                                                                    <b>Customer Name</b>
                                                                    <asp:Label ID="lblEVOSAPCust" runat="server" Text=""  ForeColor="Blue"></asp:Label>
                                                                </td>
                                                                <td style="padding-left:10px">
                                                        ...
                                                        <table width="100%" style="border-style:solid;border-width:0px;background-color:#FDF3CD">
                                                            <tr>
                                                                <td style="width:40%;padding-left:10px">
                                                                    ...
                                                                    <asp:Label ID="lblEVOSAPVendor" runat="server" Text=""  ForeColor="Blue"></asp:Label>
                                                                </td>
                                                                <td style="padding-left:10px">
        ...
        <table width="100%">
            ...
            <tr style="height:55px">
                ...
                <td style="width:25%" align="center">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnHold" runat="server" Text="Put On Hold" Width="90px" Font-Bold="true" Visible="true" onclick="btnHold_Click" CssClass="btnStyle" ToolTip="Clicking Hold button lets the user to save the new comments at the same level and does not escalates order to further level, New uploaded files will be saved and emails will be sent in this case." />
            ...
            <uc1:MsgBoxControl ID="MsgBoxControl1" runat="server" />
                      ...
                      <asp:Button ID="btnCancelAtView" runat="server" Font-Bold="True" Width="180px" 
                        onclick="btnCancelAtView_Click" Text="Cancel Order Unattended" Visible="False"  
                        CssClass="btnStyle" 
                        
    ToolTip="Order once canceled will be permanantly out of escalation system. Please verify before you proceed." />
 <br />
</div>

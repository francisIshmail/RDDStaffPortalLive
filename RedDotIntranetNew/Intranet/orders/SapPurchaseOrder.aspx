<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern.master" AutoEventWireup="true" CodeFile="SapPurchaseOrder.aspx.cs" Inherits="Intranet_orders_SapPurchaseOrder" EnableEventValidation="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <script type="text/javascript">
      ...
      function confirmCBN() {
          var ddl = document.getElementById("<%= ddlCBNName.ClientID %>");
          var SelVal = ddl.options[ddl.selectedIndex].text;
          alert("Confirmation ! You have selected CBN : '" + SelVal + "'"); //SelVal is the selected Value
      }
      ...
      function updateValuesNew(rw,senderID) {
          ...
          */
          ...
          //call sellprice on blur confirmation here
          if (senderID == "txtSelleingPrice") {
              //alert("Sell Price Confirmation ! " + senderID + " row :" + rw.toString());
              alert("Confirmation ! Your Entries on Row : " + rw.toString() + " are : Qty : " + qt.toString() + " , Price : " + pr.toString() + " , Rebate : " + RebatePerUnit.toString() + " , Sell Price : " + SellingPrice.toString());
          }
      ...
      function setImage(btnID) {
                              ...
                              <tr style="height:30px;background-color:#507CD1"> <%--row 1--%>
                                 <td style="width:96%" align="center">
                                    <div class="Page-Title">
                                        SAP Purchase Order Request Form
                                    </div>
                                    
                                </td>
                                <td style="width:4%;">
                                   <div class="Page-Title">
                                     <a href="SapViewOrdersPO.aspx?wfTypeId=10011" style="color:White;font-size:12px" >Back</a>
                                    </div>
                                </td>
                             </tr>
                    </table>
       ...
       <asp:Label ID="lblPermissionMsg" runat="server" ForeColor="Red" Text="" Font-Bold="True" Font-Size="14px"></asp:Label>
        <table style="width:100%" runat="server" id="tblMain">
                                                      ...
                                                      <table width="100%" border="0px">
                                                        <tr>
                                                            <td style="width:90%;font-weight:bold" align="right">
                                                                Select Customer ( <asp:Label ID="lblEVOSAP" runat="server" Text="EVO" Font-Size="9px" Font-Bold="true" Visible="true" ForeColor="Blue"></asp:Label>):
                                                                &nbsp;<asp:DropDownList ID="ddlCustList" Width="180px" runat="server" Visible="true" BackColor="silver" > </asp:DropDownList>
                                                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width:25%;font-weight:bold" align="right">
                                ...
                                <asp:DropDownList ID="ddlCBNName" runat="server" Width="170px" AutoPostBack="false" 
                                    Font-Bold="false" BackColor="#ffbbbb" > </asp:DropDownList>
                             </td>
                          ...
                          <asp:TemplateField HeaderText="PartNo">
                             <ItemTemplate> 
                                <table style="width:100%">
                                     <tr >
                                          <td style="width:20%;color:Maroon">
                                            Find Part Like....
                                          </td>
                                          <td style="width:20%">
                                            <asp:TextBox ID="txtFindPartLike" Text='<%# DataBinder.Eval(Container.DataItem, "txtFind")%>' runat="server" Width="75%" Font-Size="10px" ForeColor="Maroon"  BackColor="#6699ff" Font-Bold="true" ></asp:TextBox>
                                            <asp:Label ID="lblFindPartLike" Text="x" runat="server" Font-Size="9px" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
                                          </td>
                                          <td style="width:7%">
                                           <asp:ImageButton ID="imgBtnFind" ImageUrl="~/images/view.png"  runat="server" ToolTip="click! to Find part no. like.. " OnClick="imgBtnFind_Click"/>
                                          </td>
                                          <td style="width:50%">
                                            <asp:DropDownList ID="ddlPartNo" Width="97%" Font-Size="10px" ForeColor="White"  BackColor="#507CD1" Font-Bold="true" runat="server" onselectedindexchanged="ddlPartNo_SelectedIndexChanged"  Visible="true" AutoPostBack="true"> </asp:DropDownList>
                                          </td>
                                          <td style="width:3%">
                                           (<asp:Label ID="lblItemsCnt" runat="server" Text="0" Font-Size="10px" Font-Bold="true" Visible="true" ForeColor="Blue"></asp:Label>)
                                          </td>
                                     </tr>
                                     <tr>
                                          <td style="width:20%">
                                          ...
                                          <td colspan="4">
                                            <asp:TextBox ID="txtPartNo" Enabled="false" Text='<%# DataBinder.Eval(Container.DataItem, "PartNo")%>' runat="server" Width="97%" Font-Size="10px" ForeColor="#666666"  BackColor="#eaeaea" Font-Bold="true" ></asp:TextBox>
                                          </td>
                                     </tr>
                                     <tr>
                                          <td style="width:20%">
                                          ...
                                          <td colspan="4">
                                           <asp:TextBox ID="txtDescription" Enabled="false" Text='<%# DataBinder.Eval(Container.DataItem, "Description")%>' runat="server" MaxLength="254" Width="98%" Font-Size="10px" ForeColor="#666666" Font-Bold="true" BackColor="#eaeaea"></asp:TextBox>
                                          </td>
                                     </tr>
                                </table>
            ...
            <br />
            <asp:Label ID="lblBU" runat="server" Font-Size="12px" Font-Bold="True" 
                Visible="False"></asp:Label>&nbsp;
            <asp:Label ID="lblItemGroup" runat="server" Font-Size="12px" Font-Bold="True" 
                Visible="False"></asp:Label>&nbsp;
            <asp:Label ID="lblVendorForBU" runat="server" Font-Size="12px" Font-Bold="True" 
                Visible="False"></asp:Label>
            <asp:Label ID="lblVendorAcct" runat="server" Font-Size="12px" Font-Bold="True" 
                Visible="False"></asp:Label>

<%@ Page Title="" Language="VB" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="false" CodeFile="EditStockItemVB.aspx.vb" Inherits="Intranet_EVO_EditStockItemVB" %>
                 ...
                 <table style="width:98%;margin-bottom:10px;margin-top:10px;margin-left:1%;" border="0px">
                      <tr style="height:60px">
                        ...
                        <td style="width:20%"  align="left">
                            <asp:DropDownList ID="ddlDB" runat="server" Width="200px" AutoPostBack="True" Font-Bold="true" BackColor="#F2F2F2">
                         ...
                         <td style="width:35%;padding-left:10px"  align="left">
                             ...
                             <asp:DropDownList ID="ddlCodeFilter" runat="server" Width="60px" 
                                 Font-Bold="true" BackColor="#F2F2F2" AutoPostBack="True"></asp:DropDownList>
                         </td>
                         <td style="width:27%"  align="right">
                            ...
                            <asp:Button ID="btnConnect" runat="server" Font-Bold="true" ForeColor="#990033" Text="Fetch Stock Items" width="150px" />
                         </td>
                    </tr>
                                ...
                                <table style="width:100%;background-color:White" border="0px">
                                   <tr style="height:40px">
                                        ...
                                        <td style="width:48%;padding-left:5px" valign="top">
                                            <asp:DropDownList ID="ddlSimpleCode" runat="server" Font-Bold="true" ForeColor="White" AutoPostBack="true" Width="72%" BackColor="#CCCCCC"></asp:DropDownList>
                                            ...
                                            <table width="100%" style="height:250px">
                                                <tr>
                                                    ...
                                                    <td style="width:70%;padding-left:5px">
                                                        <asp:DropDownList ID="cmbCatTRI" runat="server"  Width="280px" AutoPostBack="True"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:30%;padding-left:40px">
                                                        <asp:CheckBox ID="chkSeg2" runat="server" Text="Manufacture" AutoPostBack="True" Enabled="True" />
                                                    </td>
                                                    <td style="width:70%;padding-left:5px">
                                                        <asp:DropDownList ID="cmbManTRI" runat="server"  Width="280px" Enabled="False" AutoPostBack="True"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:30%;padding-left:40px">
                                                    ...
                                                    <td style="width:70%;padding-left:5px">
                                                        <asp:DropDownList ID="cmbBUTRI" runat="server"  Width="280px" Enabled="False" AutoPostBack="True"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:30%;padding-left:40px">
                                                    ...
                                                    <td style="width:70%;padding-left:5px">
                                                        <asp:DropDownList ID="cmbPLTRI" runat="server"  Width="180px" Enabled="False" AutoPostBack="True"></asp:DropDownList>
                                                         <asp:TextBox ID="txtPLTRI" Width="180px" runat="server" Visible="False" Enabled="false" Height="15px"></asp:TextBox>
                                                            &nbsp;
                                                          <asp:CheckBox ID="chkNewPL" runat="server" text="New PL" Checked="false" AutoPostBack="True" ForeColor="#993399" Font-Bold="true" Enabled="False" />
                                                      </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:30%;padding-left:40px">
                                                    ...
                                                    <td style="width:70%;padding-left:5px">
                                                        <asp:DropDownList ID="cmbModelTRI" runat="server"  Width="180px" Enabled="False" AutoPostBack="True"></asp:DropDownList>
                                                        <asp:TextBox ID="txtModelTRI" Width="180px" runat="server" Visible="False" Enabled="false" Height="15px"></asp:TextBox>
                                                        &nbsp;
                                                        <asp:CheckBox ID="chkNewModel" runat="server" text="New Model" Checked="false" AutoPostBack="True" ForeColor="#993399" Font-Bold="true" Enabled="False" />                                                      
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:30%;padding-left:40px">
                                                        <asp:CheckBox ID="chkSeg6" runat="server" Text="Part #" AutoPostBack="True" Visible="true" Enabled="False" />
                                                    </td>
                                                    <td style="width:70%;padding-left:5px">
                                                        <asp:DropDownList ID="cmbPartTRI" runat="server"  Width="180px" Enabled="False" AutoPostBack="True" Visible="true"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:30%;padding-left:40px">
                                                    ...
                                                    <td style="width:70%;padding-left:5px">
                                                        <asp:DropDownList ID="cmbDashCategory" runat="server" Width="280px" AutoPostBack="True"  BackColor="Silver"></asp:DropDownList><asp:Label ID="lblColumnCount" runat="server" Font-Bold="True" ForeColor="#003366"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnUpdate" runat="server" Text="Update Item" Width="100px" Font-Bold="true" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="true" CodeFile="DownloadReps.aspx.cs" Inherits="Intranet_webReporting_DownloadReps" %>
...
<table width="80%">
    ...
    <tr style="height:40px">
        <td>
           <asp:Panel ID="panelWorkingUsers" runat="server" CssClass="POPanel1" GroupingText="You can work as follwing Users ( Work As selected one)">
                                <table width="100%">
                                    <tr>
                                      <td style="width:70%">

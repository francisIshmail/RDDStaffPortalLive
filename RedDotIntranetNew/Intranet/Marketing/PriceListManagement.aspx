<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="true" CodeFile="PriceListManagement.aspx.cs" Inherits="Intranet_EVO_PriceListManagement" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <table width="100%" style="border-color:#00A9F5;">
              <tr style="height:50px;background-color:#507CD1"> <%--row 1--%>
                <td>
                    <div class="Page-Title">PriceList Management for Marketing</div>
                </td>
             </tr>
    </table>
      ...
      <center>
        <asp:Panel ID="Panel1" runat="server" BorderColor="#006666" BorderStyle="Solid">
            <table width="90%" border="0px">
                ...
                <tr>
                        <td style="width:10%">Price List File</td>
                        <td style="width:15%">
                        ...
                        <td style="width:45%">
                                <b>Price list will be sent to below emails of ( 
        ...
        <table width="90%" border="0px">
                <tr>
                    <td colspan="5">
                        <b> Price List History from the database for (<asp:Label ID="lblSelectedCntry" runat="server" Text="None" Font-Bold="true" ForeColor="Pink"></asp:Label>)  : ( <asp:Label ID="lblListCnt" runat="server" Text="0" Font-Bold="true" ForeColor="Blue"></asp:Label> ) </b>
                        <hr />
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="5">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="ID" SortExpression="scId" Visible="false">
                                <ItemTemplate > 
                                    <asp:Label ID="lblpricelistID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "pricelistID")%>'></asp:Label>&nbsp;

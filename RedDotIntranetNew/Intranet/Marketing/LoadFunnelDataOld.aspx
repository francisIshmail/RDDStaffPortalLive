<%@ Page Language="C#" MasterPageFile="~/Intranet/MasterFunnel.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="LoadFunnelDataOld.aspx.cs" Inherits="Intranet_Marketing_LoadFunnelDataOld" Title="Manage Funnel" %>
         ...
         <td style="width: 100%;">
                    <asp:GridView ID="Grid1" AutoGenerateColumns="False" CssClass="overallGrid" 
                        ...
                        <asp:TemplateField>
                                ...
                                <ItemTemplate> 
                                 ...
                                 <EditItemTemplate>
                                  <asp:Label ID="lbl18" runat="server" Text="Order Date"></asp:Label><br />
                                       <asp:TextBox ID="txtorderBookedDate" Width="65px" runat="server" Font-Size="Small" BackColor="#ffffcc"></asp:TextBox>
                           ...
                           <%-- <asp:TemplateField HeaderText="Sales Person" Visible="true">
                                <ItemTemplate> 
                                 <table width="100%">
                                   <tr>
                                      <td style="width:25%;"><asp:Label ID="lbl151" runat="server" Text="Remarks"  ForeColor="Blue"></asp:Label></td>
                                      <td style="width:75%;">&nbsp;</td> 
                                   </tr>
                                   <tr>
                                    <td><asp:Label ID="lbl171"  Font-Size="Smaller" runat="server" Text="User Date"  ForeColor="Blue"></asp:Label></td> 
                                     <td>&nbsp;</td> 
                                   </tr>
                                 </table>
                                 ...
                                 <EditItemTemplate>
                                  ...
                                  <table width="100%" border="1">
                                   <tr>
                                     <td style="width:25%;"><asp:Label ID="lbl15" runat="server" Text="Remarks"  ForeColor="Blue"></asp:Label></td> 
                                     <td style="width:75%;">&nbsp;</td>
                                   </tr>
                                   <tr>
                                     <td><asp:Label ID="lbl17"  Font-Size="Smaller" runat="server" Text="User Date"  ForeColor="Blue" ></asp:Label></td> 
                                     <td>&nbsp;</td>
                                   </tr>
                                 </table>
                                </EditItemTemplate>

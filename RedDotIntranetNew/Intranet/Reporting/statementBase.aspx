<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master"
    AutoEventWireup="true" CodeFile="statementBase.aspx.cs" Inherits="Intranet_Reporting_statementBase" %>
    ...
    <div class="main-content-area" style="background-image: url('../images/bgimg.png');">
        <center>
            ...
            <table width="80%">
                ...
                <tr>
                    <td style="width: 40%">
                        <asp:Button ID="btnReport" runat="server" Text="Click! Generate Statement" Font-Bold="True"

<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master" AutoEventWireup="true" CodeFile="ReportTrackingDownloads.aspx.cs" Inherits="Intranet_Reporting_ReportTrackingDownloads" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="main-content-area" style="background-image: url('../images/bgimg.png');">
        <center>
            <p class="title-txt" >
               Reports Download Tracking  System</p>
            <br />
            <br />
            ...
            <table width="80%" id="tblMain" runat="server" border="0">
                ...
                <tr style="background-color:White;" valign="bottom">
                  ...
                  <td style="width: 15%" valign="bottom">
                      ...
                      &nbsp;<asp:CheckBox runat="server" ID="chkBUAll" Text="All" Font-Bold="true" Font-Size="12px" ForeColor="Blue"  />
                  </td>
                ...
                <tr style="background-color:White;" valign="top">
                  ...
                  <td valign="top">
                    <asp:DropDownList ID="ddlBus" runat="server" Width="150px" AutoPostBack="false" 

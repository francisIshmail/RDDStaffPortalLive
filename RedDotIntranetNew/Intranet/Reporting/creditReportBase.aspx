<%@ Page Title="" Language="C#" MasterPageFile="~/Intranet/MasterIntern_1.master"
    AutoEventWireup="true" CodeFile="creditReportBase.aspx.cs" Inherits="Intranet_WMS_creditReportBase" %>
    ...
    <div class="main-content-area" style="background-image: url('../images/bgimg.png');">
        <center>
            ...
            <table width="80%">
                ...
                <tr>
                    <td style="width: 40%">
                        <asp:Button ID="btnReport" runat="server" Text="Click! Generate Report" Font-Bold="True"
                            Width="170px" OnClick="btnReport_Click1" />
                    </td>
                    <td style="width: 60%">
                        &nbsp;
                    </td>

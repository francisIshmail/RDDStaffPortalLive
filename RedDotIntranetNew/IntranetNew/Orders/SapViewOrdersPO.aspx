<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="SapViewOrdersPO.aspx.cs" Inherits="IntranetNew_Orders_SapViewOrdersPO" %>
...
<table width="100%">
        <tr>
            <td>
              <%--<asp:Panel ID="panel1ProcessType" runat="server" style="background-color:#CCCCCC;border:1px solid black;" GroupingText="Select Process & Status">--%>
                 <table width="100%" >
                  <tr>
                        <td style="width:8%;">
                         <label style="padding: 5px 12px; margin: 3px 0;font-family: Raleway; font-size:14px; font-weight:bold; ">Process   </label>  
                            <%--<asp:Label ID="Label11" runat="server" Text="Process" Font-Size="12px" ForeColor="#666666" Font-Bold="True"></asp:Label>--%>
                        </td>
                        <td style="width:16%;">
                            <asp:DropDownList ID="ddlProcessType" runat="server" Width="90%"  
                        ...
                        <td align="center" style="width:20%;">
                         SAP - &nbsp;
                            <asp:Label ID="lblTypeSelected" runat="server" Text="" Font-Size="16px" ForeColor="Blue" Font-Bold="True"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:8%;">
                            <label style="padding: 5px 12px; margin: 3px 0;font-family: Raleway; font-size:14px; font-weight:bold; ">Status   </label>  
                            <%--<asp:Label ID="Label1" runat="server" Text="Status" Font-Size="12px" ForeColor="#666666" Font-Bold="True"></asp:Label>--%>
                        </td>
                        <td style="width:16%;">
                        ...
                        <td style="width:25%;">  <asp:CheckBox ID="chkStatusAll" runat="server"  AutoPostBack="True" 

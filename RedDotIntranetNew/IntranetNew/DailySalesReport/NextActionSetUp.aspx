<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="NextActionSetUp.aspx.cs" Inherits="IntranetNew_DailySalesReport_NextActionSetUp" %>
                    ...
                    <asp:GridView ID="GRVAutoCLStatusChange" runat="server" AllowSorting="true"    DataKeyNames="Id"
                      ...
                      ShowFooter="True" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Next Action"   SortExpression="Status">
                                <ItemTemplate>
                                    <asp:Label ID="lblNextAction" runat="server" Text='<%#Eval("NextAction")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtNxtActionedit" runat="server" class="form-control" autocomplete="off"  Style="font-size: medium;"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtNxtActionFooter" runat="server" class="form-control" autocomplete="off"  Style="font-size: medium;"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>

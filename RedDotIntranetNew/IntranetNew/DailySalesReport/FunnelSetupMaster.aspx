<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="FunnelSetupMaster.aspx.cs" Inherits="IntranetNew_DailySalesReport_FunnelSetupMaster" %>
                    ...
                    <asp:GridView ID="GRVAutoCLStatusChange" runat="server" AllowSorting="true"    DataKeyNames="Id"
                      ...
                      ShowFooter="True" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="STATUS"   SortExpression="Status">
                                <ItemTemplate>
                                    <asp:Label ID="lblfunnelst" runat="server" Text='<%#Eval("FunnelStatus")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>

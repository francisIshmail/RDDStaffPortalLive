<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master"
    AutoEventWireup="true" CodeFile="DailySalesMasterNew.aspx.cs" Inherits="IntranetNew_DailySalesReport_DailySalesMasterNew" %>
...
//            if (sender._selectedDate < $("[id$=ddlCountry]").val()) {
                    ...
                    <table width="100%" align="center">
                        ...
                        <tr>
                            ...
                            <td width="100%" rowspan="4" align="right">
                                <asp:GridView ID="GvRptSummary" runat="server" RowStyle-BorderWidth="1" RowStyle-BorderColor="Red"
                                    class="rounded_corners" Font-Bold="True" HeaderStyle-BackColor="#d71313" HeaderStyle-ForeColor="Black"
                                    RowStyle-BackColor="#A1DCF2" RowStyle-ForeColor="#3A3A3A" Width="60%" BackColor="White"
                        ...
                        <tr>
                            <td colspan="6">
                                <asp:Button ID="btnsaveasdraft" runat="server" class="btn btn-primary" Font-Bold="true"
                                    ToolTip="Save As Draft" Font-Size="Small" Style="width: 10%; padding: 5px 12px;
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="SUBMIT" class="btn btn-success" Font-Size="Small"
                                    ToolTip="Submit Final Report" Style="width: 10%; padding: 5px 12px; margin: 4px 0;
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="header-center" 
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <%--  <asp:RegularExpressionValidator ID="RegularExpressionValidator" runat="server" 
                                                        ControlToValidate="txtEmail" ErrorMessage="Please Enter valid EmailID" 
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="header-center" 
                                            ...
                                            <EditItemTemplate>
                                                <asp:DropDownList ID="ddlNextActionEdit" runat="server" class="form-control" 
                                                    Text='<%#Eval("NextAction")%>'>
                                                    <asp:ListItem>--Select--</asp:ListItem>
                                                    <asp:ListItem>Pending</asp:ListItem>
                                                    <asp:ListItem>Closed</asp:ListItem>
                                                    <asp:ListItem>Lead Gen</asp:ListItem>
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                            <FooterTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="ModeOfCallSetUp.aspx.cs" Inherits="IntranetNew_DailySalesReport_FunnelSetupMaster" %>
                    ...
                    <asp:GridView ID="GRVAutoCLStatusChange" runat="server" AllowSorting="true"    DataKeyNames="Id"
                      ...
                      ShowFooter="True" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="MODE OF CALL"   SortExpression="Status">
                                <ItemTemplate>

...
public partial class IntranetNew_Admin_UserCreationMembershipDatabase : System.Web.UI.Page
{
    string[] arrRoles;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            int count = Db.myExecuteScalar("Select COUNT(*) from dbo.MenuWiseForms t0 Join dbo.UserAuthorization t1 on t0.MenuId=t1.MenuId and t1.MembershipUserName='" + myGlobal.loggedInUser() + "' And t0.FormURL='UserCreationMembershipDatabase.aspx' and t1.IsActive=1");
            if (count > 0)
            {
                updateRoleDDL();
                updateUsersDDL();
            ...
            {
                Response.Redirect("Default.aspx?UserAccess=0&FormName=Website Administration");
            }
        }

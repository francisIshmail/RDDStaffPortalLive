<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="FormsMaster.aspx.cs" Inherits="IntranetNew_Admin_FormsMaster" %>
...
<tr>
    <td width="100%" align="center" >
         <Lable style="color: #d71313;font-size:x-large;font-weight: bold;font-family: Raleway;" > &nbsp;&nbsp;&nbsp; Form Master </Lable>
    </td>
</tr>
...
<asp:Panel ID="pnlForms" runat="server" Width="50%"  Height="25%" BorderWidth="1px" BorderColor="Red" EnableTheming="true">
...
<table width="90%" align="center" cellpadding="3px" cellspacing="3px" >
    ...
    <tr>
      ...
      <tr>
        ...
        <td width="35%" align="left">
           <label style="padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; font-weight:normal; ">Menu  &nbsp; </label>  
        </td>
        <td width="45%">
            <asp:DropDownList ID="ddlMenu" runat="server" style="width:65%;padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; ">
            </asp:DropDownList>
      ...
      <tr>
        ...
        <td width="35%" align="left">
           <label style="padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; font-weight:normal; "> Form Name   &nbsp;  </label>
        </td>
        <td width="45%" >
            <asp:TextBox ID="txtFormName" runat="server" style="width:65%;padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; "></asp:TextBox> 
         </td>
    ...
    <tr >
        ...
        <td width="35%" align="left">
            <label style="padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; font-weight:normal; "> FormURL   &nbsp;  </label>
        </td>
        <td width="45%">
            <asp:TextBox ID="txtFormURL" runat="server" style="width:65%;padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; "></asp:TextBox>
        </td>
         <td width="20%" align="left">
        </td>
    </tr>
 <%--   <tr >
        <td width="35%" align="left">
            <label style="padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; font-weight:normal; "> Display Sequence   &nbsp;  </label>
        </td>
        <td width="45%">
            <asp:TextBox ID="txtDisplySeq" runat="server" style="width:65%;padding: 5px 12px; margin: 3px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; "></asp:TextBox>
        </td>
         <td width="20%" align="left">
        </td>
    </tr>--%>
        ...
        <asp:GridView ID="Gridview1" runat="server" AutoGenerateColumns="false" 
                ...
                >
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="13%"  HeaderText="Menu">
                            <ItemTemplate>
                         ...
                         <asp:TemplateField ItemStyle-Width="25%" HeaderText="Form Name">
                            <ItemTemplate >
                       ...
                       <%-- <asp:TemplateField ItemStyle-Width="10%" HeaderText="DispSeq">
                            <ItemTemplate>
                                <asp:Label ID="lblDisplaySeq" runat="server" Text='<%#Eval("DisplaySeq")%>' ></asp:Label>
                            </ItemTemplate>
                            <ItemStyle CssClass="gvItemCenter" />
                            <HeaderStyle CssClass="gvHeaderCenter" />
                        </asp:TemplateField>--%>

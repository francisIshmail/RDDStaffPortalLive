<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="BPManualChangeTransStatusAlert.aspx.cs" Inherits="IntranetNew_Admin_BPManualChangeTransStatusAlert" %>
...
<asp:ScriptManager ID="SMManualChangeAlert" runat="server" > </asp:ScriptManager>
<asp:UpdatePanel ID="UPManualStatusChangeAlert" runat="server">
<ContentTemplate>

<table width="100%" align="center"> 
<tr>
    <td width="100%" align="center" >
         <Lable style="color: #d71313;font-size:x-large;font-weight: bold;font-family: Raleway;" > &nbsp;&nbsp;&nbsp; Alert Setup - Manual Transactional Status Change Alerts </Lable>
    </td>
</tr>
...
<asp:Panel ID="pnlManualTransStatus" runat="server" Width="90%"  Height="25%" BorderWidth="1px" BorderColor="Red" EnableTheming="true">

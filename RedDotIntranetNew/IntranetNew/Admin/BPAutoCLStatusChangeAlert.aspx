<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="BPAutoCLStatusChangeAlert.aspx.cs" Inherits="IntranetNew_Admin_BPAutoCLStatusChangeAlert" %>
...
<tr>
    <td width="100%" align="center" >
         <Lable style="color: #d71313;font-size:x-large;font-weight: bold;font-family: Raleway;" > &nbsp;&nbsp;&nbsp; Alert Setup - Auto Credit Limit Status Change Alerts </Lable>
    </td>
</tr>
...
<asp:Panel ID="pnlAutoCLStatus" runat="server" Width="90%"  Height="25%" BorderWidth="1px" BorderColor="Red" EnableTheming="true">


        <asp:GridView ID="GRVAutoCLStatusChange" runat="server" 

<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="BPManualCLStatusChange.aspx.cs" Inherits="IntranetNew_Admin_BPManualCLStatusChange" %>
...
<asp:ScriptManager ID="SMManualCLStatusChange" runat="server" > </asp:ScriptManager>
<asp:UpdatePanel ID="UPManualCLStatusChange" runat="server">
<ContentTemplate>

<table width="100%" align="center"> 
<tr>
    <td width="100%" align="center" >
         <Lable style="color: #d71313;font-size:x-large;font-weight: bold;font-family: Raleway;" > &nbsp;&nbsp;&nbsp; Setup - To Manually Change Credit Limit Status </Lable>
    </td>
</tr>
...
<asp:Panel ID="pnlManualCLStatusChange" runat="server" Width="85%"  Height="25%" BorderWidth="1px" BorderColor="Red" EnableTheming="true">


        <asp:GridView ID="GRVManualCLStatusChange" runat="server" 
            AutoGenerateColumns="False" ShowFooter="True" Class="table table-bordered table-condensed table-hover"
            AllowSorting="true"  
            onrowcommand="GRVManualCLStatusChange_RowCommand" 
            onrowcancelingedit="GRVManualCLStatusChange_RowCancelingEdit" 
            onrowdeleting="GRVManualCLStatusChange_RowDeleting" 
            onrowediting="GRVManualCLStatusChange_RowEditing" 
            onrowupdating="GRVManualCLStatusChange_RowUpdating" 
            onsorting="GRVManualCLStatusChange_Sorting" >
         <Columns>

<%@ Page Title="" Language="C#" MasterPageFile="~/IntranetNew/IntranetNew.master" AutoEventWireup="true" CodeFile="salespersontargets.aspx.cs" Inherits="IntranetNew_Targets_SalesPersonTargets" EnableEventValidation="false"  %>
...
<tr>
    <td width="80%" align="center" colspan="2" >
         <Lable style="color: #d71313;font-size:x-large;font-weight: bold;font-family: Raleway;" > &nbsp;&nbsp;&nbsp; Sales Person Targets  </Lable>
    </td>
</tr>
...
<table width="100%" align="left" cellpadding="3px" cellspacing="3px" >
      <tr>
   ...
   <tr>
        <td width="100%" align="center" >
          &nbsp;&nbsp;  <asp:Button ID="BtnSave" runat="server" Text="Save" 
                style="width:20%;padding: 5px 12px; margin: 4px 0; box-sizing: border-box;font-family: Raleway; font-size:14px; " onclick="BtnSave_Click" OnClientClick="return getConfirmation();"
                 />  &nbsp;&nbsp; 
